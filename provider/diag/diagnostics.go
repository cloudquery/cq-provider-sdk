...
// CountBySeverity returns number of diagnostics of the given severity. If deep is false, squashed diags are counted as a single diag.
func (diags Diagnostics) CountBySeverity(sev Severity, deep bool) uint64 {
	var count uint64 = 0
