...
// TODO: How was this autogenerated? How to re-generate it?
...
func (_m *DatabaseMock) Insert(ctx context.Context, t *schema.Table, instance schema.Resources, shouldCascade bool) diag.Diagnostics {
	ret := _m.Called(ctx, t, instance)

	var r0 diag.Diagnostics
	if rf, ok := ret.Get(0).(func(context.Context, *schema.Table, schema.Resources, bool) diag.Diagnostics); ok {
