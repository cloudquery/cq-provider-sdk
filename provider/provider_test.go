			...
			ExpectedFetchResponses: []*cqproto.FetchResourcesResponse{
				{
					...
					Summary: cqproto.ResourceFetchSummary{
						...
						ResourceCount: 0,
						Diagnostics:   diag.Diagnostics{diag.NewBaseError(errors.New("table[bad_resource_ignore_error] resolver ignored error. Error: bad error"), diag.RESOLVING, diag.WithSeverity(diag.IGNORE))},
					},
				}},
			ExpectedError: nil,
			MockStorageFunc: func(ctrl *gomock.Controller) *mock.MockStorage {
