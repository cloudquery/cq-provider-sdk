			...
			ExpectedFetchResponses: []*cqproto.FetchResourcesResponse{
				{
					...
					Summary: cqproto.ResourceFetchSummary{
						...
						Diagnostics: diag.Diagnostics{diag.NewBaseError(errors.New("table[bad_resource_ignore_error] resolver ignored error. Error: bad error"),
							diag.IGNORE, diag.RESOLVING, nil, "bad_resource_ignore_error", "table[bad_resource_ignore_error] resolver ignored error. Error: bad error", "")},
					},
				}},
			ExpectedError: nil,
			MockStorageFunc: func(ctrl *gomock.Controller) *mock.MockStorage {
			...
			ExpectedFetchResponses: []*cqproto.FetchResourcesResponse{
				{
					...
					Summary: cqproto.ResourceFetchSummary{
						...
						ResourceCount: 0,
						Diagnostics:   diag.Diagnostics{diag.NewBaseError(errors.New("bad error"), diag.ERROR, diag.RESOLVING, nil, "bad_resource", "failed to resolve table \"bad_resource\"", "")},
					},
				},
			},
			MockStorageFunc: func(ctrl *gomock.Controller) *mock.MockStorage {
			...
			ExpectedFetchResponses: []*cqproto.FetchResourcesResponse{
				{
					...
					Summary: cqproto.ResourceFetchSummary{
						...
						Diagnostics: diag.Diagnostics{diag.NewBaseError(errors.New("context canceled"),
							diag.ERROR, diag.RESOLVING, nil, "very_slow_resource", "failed to resolve table \"very_slow_resource\"", "")},
					},
				}},
			ExpectedError: nil,
			MockStorageFunc: func(ctrl *gomock.Controller) *mock.MockStorage {
