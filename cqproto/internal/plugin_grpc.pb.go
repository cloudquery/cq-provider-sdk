...
type ProviderClient interface {
	...
	// TrasformTerraformResource gets list of resources to transform and push into the database
	TrasformTerraformResource(ctx context.Context, in *TrasformTerraformResource_Request, opts ...grpc.CallOption) (*TrasformTerraformResource_Response, error)
}
...
func (c *providerClient) TrasformTerraformResource(ctx context.Context, in *TrasformTerraformResource_Request, opts ...grpc.CallOption) (*TrasformTerraformResource_Response, error) {
	out := new(TrasformTerraformResource_Response)
	err := c.cc.Invoke(ctx, "/proto.Provider/TrasformTerraformResource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProviderServer interface {
	...
	// TrasformTerraformResource gets list of resources to transform and push into the database
	TrasformTerraformResource(context.Context, *TrasformTerraformResource_Request) (*TrasformTerraformResource_Response, error)
...
func (UnimplementedProviderServer) TrasformTerraformResource(context.Context, *TrasformTerraformResource_Request) (*TrasformTerraformResource_Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TrasformTerraformResource not implemented")
}
...
func _Provider_TrasformTerraformResource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TrasformTerraformResource_Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProviderServer).TrasformTerraformResource(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Provider/TrasformTerraformResource",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProviderServer).TrasformTerraformResource(ctx, req.(*TrasformTerraformResource_Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Provider_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TrasformTerraformResource",
			Handler:    _Provider_TrasformTerraformResource_Handler,
		},
	},
